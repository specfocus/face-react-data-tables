...
const DataBody: FC<DataBodyProps> = React.forwardRef(
  (
    {
      basePath,
      children,
...
export interface DataBodyProps extends Omit<TableBodyProps, 'classes'> {
  basePath?: string;
...
export const PureDataBody = memo(DataBody, areEqual);

// trick material-ui Table into thinking this is one of the child type it supports
// @ts-ignore
PureDataBody.muiName = 'TableBody';
// @ts-ignore
PureDataBody.defaultProps = {
  row: <PureDataRow />,
};
