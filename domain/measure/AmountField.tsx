...
export interface AmountFieldProps<
  ...
  // unit-system -> metric / imperial  https://en.wikipedia.org/wiki/Imperial_units "imperial system of units" "metric sytem of units"
  // unit -> length
  // scale -> in m ft, imperial / metric
  // amout
}
...
>({
  ...
  variant,
  ...props
}: AmountFieldProps<T, Multiple, DisableClearable, FreeSolo, ChipComponent>) {
